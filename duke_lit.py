...
OPENAI_API_KEY = "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"
...
if user_input:
    ...
    fig.patch.set_facecolor("#A9A9A9")  # Overall figure background
